...
public class Constants {
    ...
    public static final String DIRECTORY_NAME_ATTRIBUTE = "name";
    public static final String DIRECTORY_TYPE_ATTRIBUTE = "type";
    ...
    public static final String[] RESOURCE_ATTRIBUTE_PRIORITY = new String[] {RESOURCE_NAME_ATTRIBUTE, RESOURCE_IDENTIFIER_ATTRIBUTE};
